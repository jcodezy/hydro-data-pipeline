...
BIGQUERY_DAILY_HYDRO_TABLE = os.getenv("BIGQUERY_DAILY_HYDRO_TABLE")
...
with DAG(
    ...
    schema_fields = [
        {"name": "interval_start_date_time", "type": "TIMESTAMP", "mode": "REQUIRED"},
        {"name": "net_consumption_kwh", "type": "FLOAT", "mode": "NULLABLE"},
    ]
